       ...
       <div className="card">
           <div className="row g-0">
              <div className="col-5 col-sm-4">
                 <img src={producto.img} className="img-fluid" alt="card-horizontal-image"  />
              </div>
            <div className="col-7 col-sm-8">
              <div className="card-body">
                 <h5 className="card-title">{producto.name} </h5>
                     ...
                     <Link to={`/detail/${producto.id} `}> <button type="button" className="btn">Product detail</button></Link>
              </div>
            </div>
          </div>
      </div>
